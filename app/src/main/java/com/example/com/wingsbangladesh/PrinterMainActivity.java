/*
package com.example.com.wingsbangladesh;
...
import com.example.com.wingsbangladesh.util.DataConstants;
import com.example.com.wingsbangladesh.util.DateUtil;
import com.example.com.wingsbangladesh.util.FontDefine;
import com.example.com.wingsbangladesh.util.Printer;
import com.example.com.wingsbangladesh.util.StringUtil;
import com.example.com.wingsbangladesh.util.Util;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mBluetoothAdapter == null) {
			...
			mPrintTextBtn.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View arg0) {
					InputTextDialog dialog = new InputTextDialog(PrinterMainActivity.this, new InputTextDialog.OnOkClickListener() {
						@Override
						public void onPrintClick(String text) {
							printTextNative(text);
						}
					});
...
/*********** print Tail*******//*
	...
	private void printTextNative(String text) {
	...
	private void printImage() {
		try {
			...
			//byte[] image 	= FileOperation.getBytesFromAssets(PrinterMainActivity.this, "tes.bmp");
			...
			byte[] newline 	= Printer.printfont("\n\n",FontDefine.FONT_24PX_UNDERLINE,FontDefine.FONT_24PX_UNDERLINE,(byte)0x1A,PocketPos.LANGUAGE_ENGLISH);
	...
	private void printText2(byte[] msg) {
		try {
			...
			try {
				btoutputstream.write(PrinterCommands.SELECT_BIT_IMAGE_MODE);
			} catch (IOException e) {
				e.printStackTrace();
			}
		} catch (IOException e) {
